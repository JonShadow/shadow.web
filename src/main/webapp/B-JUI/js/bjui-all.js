...
+function ($) {
    ...
    Dialog.prototype.TOOLS = function() {
        ...
        var tools = {
            ...
            resizeBjuiForm: function($dialog) {
                var width = $dialog.width(), colWidth = BJUI.formColWidth
                
                $dialog.find('.bjui-form').each(function() {
                    var $form = $(this)
        ...
        if (height != options.height) {
            ...
            if (options.max) {
                $dialog.animate({ height:height, top:itop }, 'normal', function() {
                    $dialogContent.height(height - $dialog.find('> .dialogHeader').outerHeight()).resizePageH()
                })
            } else {
                ...
                if (h != op.height) {
                    ...
                    if (options.max) {
                        $dialog.animate({ height:h, top:itop }, 'normal', function() {
                            $dialogContent.height(h - $dialog.find('> .dialogHeader').outerHeight()).resizePageH()
                        })
                    } else {
    ...
    Dialog.prototype.maxsize = function($dialog) {
        ...
        this.tools.resizeBjuiForm($dialog)
    }
