...
<link href="B-JUI/themes/css/fontsize.css" id="bjui-link-theme"
	rel="stylesheet">
<!-- plug - css -->
<link href="B-JUI/plugins/kindeditor_4.1.10/themes/default/default.css"
	rel="stylesheet">
<link href="B-JUI/plugins/colorpicker/css/bootstrap-colorpicker.min.css"
	rel="stylesheet">
<link href="B-JUI/plugins/niceValidator/jquery.validator.css"
	rel="stylesheet">
...
<!-- nice validate -->
<script src="B-JUI/plugins/niceValidator/jquery.validator.js"></script>
<script src="B-JUI/plugins/niceValidator/jquery.validator.themes.js"></script>
<!-- bootstrap plugins -->
...
<link href="B-JUI/assets/prettify.css" rel="stylesheet">
<script src="B-JUI/assets/prettify.js"></script>
<link href="B-JUI/assets/ZeroClipboard.css" rel="stylesheet">
<script src="B-JUI/assets/ZeroClipboard.js"></script>
		...
		<div class="container_fluid">
			...
			<nav class="collapse navbar-collapse" id="bjui-top-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="#">用户：${sessionUser.username}
      				</a>
      				</li>
					<li><a href="#">角色：管理员</a></li>
					<li><a href="changepassword" data-toggle="dialog"
						data-id="sys_user_changepass" data-mask="true" data-width="400"
						data-height="300">修改密码</a></li>
					<li><a href="javascript:;" onclick="logout()" style="font-weight: bold;">&nbsp;<i
	...
	<header class="navbar bjui-header" id="bjui-navbar">
		<div class="container_fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img src="resources/images/logo2.png" width="150"
					height="30"></a>
			</div>
			<nav class="collapse navbar-collapse" id="bjui-navbar-collapsebtn">
				<ul class="nav navbar-nav navbar-right" id="bjui-hnav-navbar">
					<li class="active"><a href="resources/json/menu-form.json"
						data-toggle="sidenav" data-id-key="targetid">表单相关</a></li>
					<li><a href="resources/json/menu-base.json" data-toggle="sidenav"
						data-id-key="targetid">基础组件</a></li>
					<li><a href="resources/json/menu-datagrid.json" data-toggle="sidenav"
